...
<head>
    ...
    <title>403 - Accès refusé | Mon CV/Portfolio</title>
...
<body data-bs-theme="dark">
    ...
    <main class="container error-container my-5">
        <div class="error-content">
            ...
            <h2 class="error-message">Oups ! Accès refusé</h2>
            <p class="error-description">
                Vous n'avez pas l'autorisation d'accéder à cette page.<br>
                -<br>
                Retournez à la page d'accueil ou vérifiez si vous avez les droits nécessaires.
